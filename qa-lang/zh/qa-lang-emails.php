...
return array(
    'a_commented_body' => "^c_handle评论了你在^site_title的回复：\n\n^open^c_content^close\n\n你的回复是：^open^c_context^close\n\n添加回复请点击下面链接：\n^url\n\n该邮件为系统所发，请勿直接回复本邮件！谢谢！\n\n^site_title",
    'a_commented_subject' => "你在 ^site_title 的回复有了新评论！",
    'a_followed_body' => "^q_handle 追问了你在 ^site_title 上的回复：\n\n^open^q_title^close\n\n你的回复是：\n\n^open^a_content^close\n\n点击下面的链接来回复该问题：\n^url\n\n该邮件为系统所发，请勿直接回复本邮件！谢谢！\n\n^site_title",
    'a_followed_subject' => "你在^site_title的回复有了新追问。",
    'a_selected_body' => "恭喜！你在^site_title上的观点已被 ^s_handle 采纳：\n\n^open^a_content^close\n\n话题内容是：\n^open^q_title^close\n\n点击下面的链接来查看你的回复：\n^url\n\n该邮件为系统所发，请勿直接回复本邮件！谢谢！\n^site_title",
    'a_selected_subject' => "你在 ^site_title 上的回复已被采纳！",
    ...
    'q_answered_body' => "^a_handle 回复了你在^site_title提出的问题：\n\n^open^a_content^close\n\n你的问题是：\n\n^open^q_title^close\n\n如果你认为这就是你想要的答案，你可以选择为最佳答案：\n^url\n\n该邮件为系统所发，请勿直接回复本邮件！谢谢！\n^site_title",
